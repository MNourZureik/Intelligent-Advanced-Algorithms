...
public class HelpingFunctions {
    ...
    // Helper: Retrieve the goal position for a specific player
    private static Position getGoalPosition(GameBoard board, SquareTypes playerType) {
        for (Map.Entry<Position, SquareTypes> goal : board.getGoalsMap().entrySet()) {
            if (goal.getValue() == HelpingFunctions.getPlayerGoalType(playerType)) {
                return goal.getKey();
            }
        }
